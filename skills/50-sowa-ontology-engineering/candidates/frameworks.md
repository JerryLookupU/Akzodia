...
- Triple verification:
  ...
  - V2 predictive: answers whether a proposed category is useful or decorative.
  - V3 distinctive: stronger than generic "define scope" because it binds scope to language, agents, and purpose.
- Decision: included.
...
- Triple verification:
  ...
  - V2 predictive: diagnoses object/process/script/history/role confusion.
  - V3 distinctive: provides Sowa-specific structural backbone.
- Decision: included.
...
- Triple verification:
  ...
  - V2 predictive: identifies when schema labels cannot support inference.
  - V3 distinctive: goes beyond dictionary glosses and synonym lists.
- Decision: included.
...
- Triple verification:
  ...
  - V2 predictive: explains why superficial tags fail interoperability.
  - V3 distinctive: preserves pragmatics, not only syntax and semantics.
- Decision: included.
...
- Triple verification:
  ...
  - V2 predictive: handles ambiguous examples like patient/result or agent/effector/instrument.
  - V3 distinctive: operationalizes Sowa's participant matrices.
- Decision: included.
...
- Triple verification:
  ...
  - V2 predictive: detects flat status enums that cannot support causal reasoning.
  - V3 distinctive: combines process taxonomy with engineering approximation.
- Decision: included.
...
- Triple verification:
  ...
  - V2 predictive: tells when to add/delete distinctions or reject a universal theory.
  - V3 distinctive: Sowa's engineering stance against closed grand systems.
- Decision: included as validation and boundary guidance, not as a standalone workflow.
