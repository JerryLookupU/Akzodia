# Rejected Candidate Units

The following units were considered during book2skill extraction but rejected by triple verification.
...
- V3 non-triviality: not actionable enough.
...
- V3 non-triviality: failed as a standalone unit.
...
- V3 non-triviality: passed, but evidence completeness failed.
...
- V2 predictive power: partial.
- V3 non-triviality: passed.
- Decision: folded into examples only.

## R5: Generic "Keep It Simple" Principle

- Source: many passages.
- Reason: Too generic. The accepted version is narrower: simple de facto alternatives can win when official standards are complex, late, untested, or migration-hostile.
- V1 cross-source support: passed.
- V2 predictive power: too broad.
- V3 non-triviality: failed.
